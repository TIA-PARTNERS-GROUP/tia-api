...
func TestBusinessService_Integration_CreateAndGet(t *testing.T) {
	...
	businessService := services.NewBusinessService(testDB)
...
func TestBusinessService_Integration_DeleteBusiness(t *testing.T) {
	...
	t.Run("Success - No Dependencies", func(t *testing.T) {
		...
		testDB.Create(&businessToDelete)
...
func TestBusinessService_Integration_GetUserBusinesses(t *testing.T) {
	...
	testDB.Create(&models.Business{Name: "Biz 1", OperatorUserID: user1.ID, BusinessType: "Other", BusinessCategory: "Mixed", BusinessPhase: "Growth"})
	testDB.Create(&models.Business{Name: "Biz 2", OperatorUserID: user1.ID, BusinessType: "Other", BusinessCategory: "Mixed", BusinessPhase: "Growth"})
	testDB.Create(&models.Business{Name: "Biz 3", OperatorUserID: user2.ID, BusinessType: "Other", BusinessCategory: "Mixed", BusinessPhase: "Growth"})
...
func TestBusinessService_Integration_ToggleBusinessStatus(t *testing.T) {
	...
	testDB.Select("*").Create(&business) // Ensure 'Active' is set
