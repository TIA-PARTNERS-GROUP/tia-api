...
func TestSkillService_Integration_CreateAndGet(t *testing.T) {
	cleanupTestDB(t)
	skillService := services.NewSkillService(testDB)
...
func TestSkillService_Integration_CreateDuplicate(t *testing.T) {
	...
	testDB.Create(&models.Skill{Name: "Duplicate Skill", Category: "Test"})
...
func TestSkillService_Integration_DeleteSkill(t *testing.T) {
	...
	t.Run("Failure - Skill In Use", func(t *testing.T) {
		...
		testDB.Create(&skill)
		testDB.Create(&models.UserSkill{UserID: user.ID, SkillID: skill.ID})
...
func TestSkillService_Integration_GetSkillsFiltered(t *testing.T) {
	...
	testDB.Model(&models.Skill{}).Create(map[string]interface{}{"Name": "Golang", "Category": "Backend", "Active": true})
	testDB.Model(&models.Skill{}).Create(map[string]interface{}{"Name": "TypeScript", "Category": "Frontend", "Active": true})
	testDB.Model(&models.Skill{}).Create(map[string]interface{}{"Name": "Java", "Category": "Backend", "Active": false})
