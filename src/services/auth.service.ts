...
export class AuthService {
   ...
   */
  static async login(loginData: LoginRequest, ipAddress?: string, userAgent?: string): Promise<LoginResponse> {
   ...
   */
  static async validateToken(token: string): Promise<{ user: any; session: any }> {
    try {
